...
@Service
public class KakaoUserService extends AbstractUserService{
    public KakaoUserService(UserRepository userRepository, SocialAccountRepository socialAccountRepository, SocialProviderFactory providerFactory, RestClient restClient) {
